...
public interface OrderService extends CRDService<OrderDto> {
    ...
    /**
     * Retrieves a paginated list of {@link OrderDto orders} associated with the given
     * {@link com.epam.esm.entity.User User} ID.
     *
     * @param page   the page number of the result set to retrieve
     * @param size   the number of items per page to retrieve
     * @param userId the ID of the {@link com.epam.esm.entity.User User} to retrieve {@link OrderDto orders} for
     * @return a {@link Page} object containing the requested list of {@link OrderDto} objects
     */
    Page<OrderDto> getOrdersByUserId(int page, int size, long userId);
}
