  ...
  {selectedCertificate && (
    <>
      <Row className=" ">
        ...
        <Col xs={6} md={8}>
        <p className="fs-5">{selectedCertificate.name.replace(/Gift Certificate \d*$/, "").trim()}</p>
        </Col>
      </Row>
      <Row className=" ">
        <Col xs={6} md={4}>
      ...
      <Row className=" ">
        ...
        <Col xs={6} md={8}>
        <p className="fs-5">{dateDiffInDays(selectedCertificate.createDate, selectedCertificate.duration) + " days"}</p>
        </Col>
      </Row>
      <Row className=" ">
        <Col xs={6} md={4}>
        ...
        <Col xs={6} md={8}>
        <p className="fs-5">{formatDate(selectedCertificate.createDate)}</p>
        </Col>
      </Row>
      <Row className=" ">
        <Col xs={6} md={4}>
        ...
        <Col xs={6} md={8}>
        <p className="fs-5">{formatDate(selectedCertificate.lastUpdateDate)}</p>
        </Col>
      </Row>
      <Row className=" ">
        <Col xs={6} md={4}>
        ...
        <Col xs={6} md={8}>
          <div>
            {selectedCertificate.tags.map((tag, tagIndex) => (
              <Badge pill bg="dark" className="m-1 p-2 text-truncate fs-6" key={tagIndex}>
